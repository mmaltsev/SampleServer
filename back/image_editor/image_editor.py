...
def square(data):
    ...
    print(colored('->', 'yellow') + ' new image size: ' + str(max(data.size)) + \
      'x' +str(max(data.size)) + '.')
...
@click.option('--height', help='Height of image. Specified only for croping, resizing and beautifier. Default = 100px.')
